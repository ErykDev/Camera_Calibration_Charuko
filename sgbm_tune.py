...
root = '/home/eryk-dev/Desktop/inzynieka/Calibration_Code/stereo_kalibracja_22_06_2023/'

imgLeft = cv2.imread(root + '/cam3_rectyfied/78.png', 0) #pair_img [0:photo_height,0:image_width] #Y+H and X+W
imgRight = cv2.imread(root + '/cam5_rectyfied/78.png', 0) #pair_img [0:photo_height,image_width:photo_width] #Y+H and X+W
